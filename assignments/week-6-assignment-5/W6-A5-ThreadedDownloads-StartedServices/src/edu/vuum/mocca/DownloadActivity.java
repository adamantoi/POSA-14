...
public class DownloadActivity extends DownloadBase {
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
        	...
        	Intent i = DownloadIntentService.makeIntent(getApplicationContext(), handler, getUrlString());
            startService(i);
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	Intent in = ThreadPoolDownloadService.makeIntent(getApplicationContext(), handler, getUrlString());
        	startService(in);
